    ...
    App.prototype.componentDidLoad = function () {
        {
            rIC(function () {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./tap-click-176f9576.js').then(function (module) { return module.startTapClick(config); });
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-adebe4f0.js').then(function (module) { return module.startStatusTap(); });
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-80c2d3b0.js').then(function (module) { return module.startInputShims(config); });
                }
                if (config.getBoolean('hardwareBackButton', isHybrid)) {
                    import('./hardware-back-button-e680d15b.js').then(function (module) { return module.startHardwareBackButton(); });
                }
                if (typeof window !== 'undefined') {
                    import('./keyboard-8164bc97.js').then(function (module) { return module.startKeyboardAssist(window); });
                }
                import('./focus-visible-b0179cd6.js').then(function (module) { return module.startFocusVisible(); });
            });
        }
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, import('./swipe-back-505d69fa.js')];
                    case 1:
