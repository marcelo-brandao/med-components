    ...
    static get methods() { return {
        "complete": {
            "complexType": {
                ...
                "parameters": [{
                        "tags": [{
                                "text": "listOrReorder A list of items to be sorted and returned in the new order or a\rboolean of whether or not the reorder should reposition the item.",
                                "name": "param"
                            }],
                        "text": "A list of items to be sorted and returned in the new order or a\rboolean of whether or not the reorder should reposition the item."
                    }],
                "references": {
                    "Promise": {
                        "location": "global"
