        ...
        "dismiss": {
            "complexType": {
                ...
                "parameters": [{
                        ...
                        "tags": [{
                                "text": "role The role of the element that is dismissing the loading.\rThis can be useful in a button handler for determining which button was\rclicked to dismiss the loading.\rSome examples include: ``\"cancel\"`, `\"destructive\"`, \"selected\"`, and `\"backdrop\"`.",
                                "name": "param"
                            }],
                        "text": "The role of the element that is dismissing the loading.\rThis can be useful in a button handler for determining which button was\rclicked to dismiss the loading.\rSome examples include: ``\"cancel\"`, `\"destructive\"`, \"selected\"`, and `\"backdrop\"`."
                    }],
                "references": {
                    "Promise": {
                        "location": "global"
