...
const haptic = require('./haptic-703380a3.js');
const spinnerConfigs = require('./spinner-configs-ee876e1e.js');
...
const Refresher = class {
    ...
    async setupiOSNativeRefresher(pullingSpinner, refreshingSpinner) {
        ...
        this.gesture = (await Promise.resolve().then(function () { return require('./index-adbbda36.js'); })).createGesture({
            el: this.scrollEl,
