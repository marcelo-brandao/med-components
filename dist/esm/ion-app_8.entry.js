...
import { b as getIonMode, c as config, i as isPlatform } from './ionic-global-2b52b731.js';
import { c as clamp } from './helpers-52552c9a.js';
import { t as transition } from './index-25df50e1.js';
import { g as getTimeGivenProgression } from './cubic-bezier-868593f2.js';
import { c as createColorClasses, h as hostContext } from './theme-206ba98b.js';
import { a as attachComponent, d as detachComponent } from './framework-delegate-060d3b8b.js';
    ...
    componentDidLoad() {
        {
            rIC(() => {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./tap-click-176f9576.js').then(module => module.startTapClick(config));
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-adebe4f0.js').then(module => module.startStatusTap());
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-80c2d3b0.js').then(module => module.startInputShims(config));
                }
                if (config.getBoolean('hardwareBackButton', isHybrid)) {
                    import('./hardware-back-button-e680d15b.js').then(module => module.startHardwareBackButton());
                }
                if (typeof window !== 'undefined') {
                    import('./keyboard-8164bc97.js').then(module => module.startKeyboardAssist(window));
                }
                import('./focus-visible-b0179cd6.js').then(module => module.startFocusVisible());
            });
        }
    }
    render() {
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await import('./swipe-back-505d69fa.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
