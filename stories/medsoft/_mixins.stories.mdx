...
Mixin criado para estilização pontual no tamanho de tela específicos e dispositivos da **família iphone X**.
...
**[variáveis SASS](http://desenv.ordomederi.com/med-components/?path=/story/medsoft-variables--page)**, como mostra o
exemplo abaixo.
