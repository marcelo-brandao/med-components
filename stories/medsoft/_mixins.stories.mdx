...
Mixin criado para podermos estilizar pontualmente valores no tamanho de tela específicos
de dispositivos da **família iphone X**. Esse mixins são geralmente utilizados para ajustar a altura do header devido ao
**[chanfrado](https://support.apple.com/en-ca/HT207354)** presente nesses dispositivos, e se for o caso, deve ser utilizado
em conjunto com as **[variáveis SASS](http://desenv.ordomederi.com/med-components/?path=/story/medsoft-variables--page)**, como mostra o exemplo abaixo.
